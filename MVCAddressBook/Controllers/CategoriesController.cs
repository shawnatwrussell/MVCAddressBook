...
namespace MVCAddressBook.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,ContactId,Name")] Category category, IFormFile Poster)
        {
            ...
            {
                category.ContentType = _imageService.RecordContentType(Poster);
                category.Poster = await _imageService.EncodePosterAsync(Poster);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryId,ContactId,Name")] Category category, IFormFile NewPoster)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        category.ContentType = _imageService.RecordContentType(NewPoster);
                        category.Poster = await _imageService.EncodePosterAsync(NewPoster);
